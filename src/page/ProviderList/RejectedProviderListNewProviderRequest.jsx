...
const RejectedProviderListNewProviderRequest = () => {
                    ...
                    <div className="duration-500">
                        <div className="w-full md:w-3/4 mx-auto border-2 p-2 rounded-lg relative">
                            ...
                            <div className="flex justify-between items-center ">
                                ...
                                <div>
                                    <button onClick={() => handleUserRemove(userDataFull)} className="py-2 px-8 bg-[#778beb] text-white rounded">Accept</button>
                                </div>
                            </div>
...
export default RejectedProviderListNewProviderRequest;
